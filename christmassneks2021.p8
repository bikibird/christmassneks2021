...
function ho_ho_ho()
	...
	destinations=
	{
		...
		[2]={x=32,y=98,dx=1,dy=0,s={103,57,58}},
		[3]={x=65,y=98,dx=1,dy=0,s={103,57,58},move_gifts=true},
		[4]={x=65,y=128,dx=0,dy=1,s={207,159,191},leave_gifts=true},
...
function uh_oh()
	...
	destinations=
	{
		[1]={x=20,y=98,dx=0,dy=-1,s={207,159,191}},
		[2]={x=32,y=98,dx=1,dy=0,s={103,57,58}},
		[3]={x=70,y=98,dx=1,dy=0,s={103,57,58},move_gifts=true},
		[4]={x=80,y=98,dx=1,dy=0,s={207,159,191}},
		[5]={x=128,y=98,dx=1,dy=0,s={103,57,58}}
	}
	robot_step=cocreate(robot_ambulator)
	sfx(-1)	
	music(8,1000)
...
function robot_ambulator()
	...
	for destination in all(destinations) do
		...
		if destination.leave_gifts then
			leave_gifts=true
		end	
		while not (robot.x ==destination.x and robot.y ==destination.y) do
			if frame%5==0 then
				...
				if (move_gifts and not leave_gifts) then
					gifts.x=robot.x+8
					gifts.y=robot.y-10
				end
...
function create_achievements()
	...
	if (robot_dance) achievements[7].locked=false
...
function draw_intro()
	...
	print("❎ DISCONNECT OUTLET",8,105,mid_blue)
	print("🅾️ DISCONNECT FINIAL",8,111,mid_blue)
			...
			if (not (gameover and fuses_blown)) then
				if not plugged_in then  --Dark Mode
					...
					if winner then
						...
						if move_gifts then
							spr(204,gifts.x,gifts.y,2,3)
							spr(222,gifts.x+16,gifts.y+8,1,2)
							spr(239,gifts.x+24,gifts.y+16,2,2)
							spr(253,gifts.x+8,gifts.y+24,2,1)
						end
					else
						spr(robot.s[robot.index],robot.x,robot.y,1,2)
					end	
...

...

...

...

...
00000000000b3bb3333333333b3bbbbb3333333c1bbbbbbbb333333bbb33bbb33333000000000000755700755755007588888898848888888998888888000000
...

...
0000000b0000b0bbb3333330b3033033330033311333333000000303bb3b30bbbbbbbbb00000000057500000000057509a000000008888888998888888000000
